...
export function renderGameUi(state, level) {
  ...
  if (state.screen === "complete") {
    ...
    screen.setAttribute("aria-label", "Measurement Master certificate");
    ...
    card.innerHTML = `
      ...
      <div class="game-certificate__stamps" aria-label="Skills mastered">
        <div class="game-certificate__stamp game-certificate__stamp--shapes"><i aria-hidden="true">⚖</i><strong>Weight</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--families"><i aria-hidden="true">kg</i><strong>Units</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--motion"><i aria-hidden="true">💧</i><strong>Capacity</strong></div>
      </div>
