const DEFAULT_STATES = {
  idle: {
    src: "assets/ui/sparky/idle.webp",
    columns: 4,
    rows: 3,
    frameCount: 12,
    anchorBottom: 356,
  ...
  correct: {
    src: "assets/ui/sparky/modified_thubms_up.webp",
    columns: 4,
    rows: 2,
    frameCount: 8,
  ...
  nod: {
    src: "assets/ui/sparky/updated_nod.webp",
    columns: 4,
    rows: 3,
    frameCount: 12,
    anchorY: 98.3425,
  ...
  happy: {
    src: "assets/ui/sparky/happy.webp",
    columns: 4,
    rows: 3,
    frameCount: 9,
  ...
  presentingDomo: {
    src: "assets/ui/sparky/final_presentation_clean.webp",
    columns: 4,
    rows: 3,
    frameCount: 12,
  ...
  thinking: {
    src: "assets/ui/sparky/thinking.webp",
    columns: 4,
    rows: 3,
    frameCount: 8,
    frameSequence: [0, 1, 2, 3, 3, 2, 1, 0],
  ...
  surprised: {
    src: "assets/ui/sparky/surprised.webp",
    columns: 4,
    rows: 3,
    frameCount: 8,
    frameSequence: [0, 1, 2, 3, 3, 2, 1, 0],
  ...
  levelComplete: {
    src: "assets/ui/sparky/updated_dance_normalized.webp",
    columns: 9,
    rows: 1,
    frameCount: 16,
  ...
  load(name) {
    ...
    image.onerror = () => {
      ...
      image.src = animation.src
        .replace("assets/ui/sparky/", "assets/characters/")
        .replace(/\.webp$/, ".png");
    };
    image.src = animation.src;
  }
